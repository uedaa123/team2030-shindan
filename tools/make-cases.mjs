...
/* ── ③ 分野名（元の名前 → サイトで出す名前） ──────────── */
const GENRE = {
  /* 残り3件と少なく、テーマも近いので「だれも外れない」に寄せた */
  "いのち・孤立":     "だれも外れない",
  "高齢者・介護":     "年を重ねても動ける",
  "子ども・教育":     "子どもと学び",
  "福祉・多様性":     "だれも外れない",
...
/* 分野の並び（サイトでこの順に出る）。明るいもの・入りやすいものを前に */
const GENRE_ORDER = [
  "子どもと学び", "水辺と生きもの", "里山・森・畑", "記録して残す",
  "まちと空き家", "地域の稼ぎをつくる", "ごみを資源に戻す", "仕組みをつくる",
  "年を重ねても動ける", "だれも外れない", "いざというときに備える"
];
...
const REAL_GENRE = [
  [/河川|川|水辺|湿地|湖|海岸|流域|ビオトープ|生物多様性|魚/, "水辺と生きもの"],
  [/里山|森|林|農|棚田|放牧|みかん|産地/,                    "里山・森・畑"],
  [/公共交通|バス|鉄道|駅|歩行|ウォーカブル|回遊|居住誘導/,   "まちと空き家"],
  [/空き家|空き店舗|低未利用|公共施設|廃校|倉庫|拠点/,        "まちと空き家"],
  [/子育て|子ども|学校|教育|高校生|中学生/,                  "子どもと学び"],
  [/福祉|健康|医療|高齢|見守り|生活支援/,                    "年を重ねても動ける"],
  [/循環|再生可能|エネルギー|資源|脱炭素/,                    "ごみを資源に戻す"],
  [/歴史|文化|景観|シビックプライド|まちなみ/,               "記録して残す"],
  [/ブランド|商標|観光|地域商品|地域産業|経済|商店/,          "地域の稼ぎをつくる"]
];
